...
exports.ticketAttachmentController = {
    createTicketAttachment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { ticket_id, response_id, file_name, original_file_name, file_size, content_type, file_hash, uploaded_by, uploaded_by_type, is_public, virus_scanned, scan_result, } = req.body;
                if (!req.file) {
    ...
    getTicketAttachmnetById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const attachment = yield prisma.ticket_attachments.findUnique({
                    where: { id },
